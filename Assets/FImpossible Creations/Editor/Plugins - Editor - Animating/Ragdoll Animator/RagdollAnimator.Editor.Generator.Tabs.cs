...
namespace FIMSpace.FProceduralAnimation
{
    ...
    public partial class RagdollAnimatorEditor
    {
        ...
        public void Tabs_DrawExtra(SerializedProperty sp_ragProcessor, RagdollProcessor proc)
        {
            ...
            if (proc.ReposeMode != RagdollProcessor.EBaseTransformRepose.None) EditorGUILayout.PropertyField(sp_ext, new GUIContent("Full Ragdoll Only:", sp_ext.tooltip), GUILayout.Width(122));
            EditorGUIUtility.labelWidth = 0;
            EditorGUILayout.EndHorizontal();
